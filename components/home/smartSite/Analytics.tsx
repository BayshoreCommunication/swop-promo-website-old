...
const Analytics = () => {
  return (
    <ScrollMotionEffect
      ...
      duration="2000"
      className={
        "max-w-[420px] md:w-full h-full m-auto bg-[#F5F5F5] rounded-2xl pb-4 flex flex-col justify-between lg:col-start-2 lg:row-start-3 2xl:row-start-1 2xl:col-start-3 "
      }
    >
